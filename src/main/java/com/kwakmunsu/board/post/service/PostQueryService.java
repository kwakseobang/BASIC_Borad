...
public class PostQueryService {
    ...
    public PostResponse read(Long postId) {
        ...
        long likesCount = PostQueryService.this.likesQueryService.readLikeCount(postId);
        long favoritesCount = favoritesQueryService.countByPostId(postId);
    ...
    public List<PostPreviewResponse> readAll(PostPageableServiceRequest request) {
        ...
        for (Post post : posts) {
            ...
            long favoritesCount = favoritesQueryService.countByPostId(post.getId());
